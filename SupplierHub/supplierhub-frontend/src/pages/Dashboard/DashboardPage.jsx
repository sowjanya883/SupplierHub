...
export default function DashboardPage() {
  ...
  const notifsRaw = notifData?.data ?? notifData ?? []
  const notifs    = notifsRaw.filter(n => !userId || n.userID === userId || n.userId === userId)
  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-2 gap-4 mb-5 md:grid-cols-4">
        ...
        {isAdmin && <MetricCard label="Active Suppliers" value={activeSupp} sub="Registered" />}
