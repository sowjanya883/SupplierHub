...
const NAV = [
    ...
    },
    {
        ...
        family: 'amber',
        links: [
            { to: '/rfx', label: 'RFx Events', icon: Megaphone, badgeKey: 'rfx' },
            { to: '/requisitions', label: 'Requisitions', icon: ClipboardList },
            { to: '/purchase-orders', label: 'Purchase Orders', icon: ShoppingCart, badgeKey: 'po' },
        ],
    },
    {
        section: 'Operations',
        family: 'teal',
        links: [
            { to: '/shipping', label: 'Shipments / ASN', icon: Truck },
            { to: '/grn', label: 'GRN & Receiving', icon: PackageCheck, badgeKey: 'grn' },
        ],
    },
    {
        ...
        family: 'rose',
        links: [
            { to: '/invoices', label: 'Invoices', icon: Receipt, badgeKey: 'invoices' },
            { to: '/ncr', label: 'NCR Quality', icon: AlertTriangle, badgeKey: 'ncr' },
        ],
    },
    {
        ...
        family: 'slate',
        links: [
            { to: '/compliance-docs', label: 'Compliance Docs', icon: ShieldCheck },
